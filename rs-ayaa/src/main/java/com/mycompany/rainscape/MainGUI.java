...
public class MainGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        basicforecast_box.setBounds(60, 40, 600, 166);
        mainBanner.add(background_image);
        background_image.setBounds(0, 0, 0, 0);

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Aaliyah\\Downloads\\weather images\\CN.jpg")); // NOI18N
        mainBanner.add(jLabel1);
        jLabel1.setBounds(0, 0, 1190, 250);

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Aaliyah\\Downloads\\weather images\\SCM.jpg")); // NOI18N
        jLabel2.setToolTipText("");
        mainBanner.add(jLabel2);
        jLabel2.setBounds(0, 0, 1190, 250);
    ...
    private void weatherIMG () {
        
        String status2 = status.getText();
        
        switch (status2) {
            case "Partly cloudy" -> jLabel1.setVisible(true);
            case "clear" -> jLabel2.setVisible(true);
            default -> System.out.println("there's an error bitch");   
        }
